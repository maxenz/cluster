...
const requestStatesList = [
  ...
  { value: REQUESTS_STATUS_READY_TO_DELIVER, text: "LISTO PARA RETIRAR/ENVÍO" },
  { value: REQUESTS_STATUS_DONE, text: "ENTREGADA" },
  { value: REQUESTS_STATUS_QUOTE_ACCEPTED, text: "COTIZACION ACEPTADA" },
  { value: REQUESTS_STATUS_CANCELED, text: "COTIZACION CANCELADA" }
];
...
export { colorsList, materialsList, requestStatesList, getColorByValue };
